...
if ($link == 'accept') {
    ...
    try {
        ...
        $mail->Username   = 'ciistacna@unjbg.edu.pe';               // SMTP username
        $mail->Password   = 'EsisCiis2019.';                        // SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` also accepted
        $mail->Port       = 587;                                    // TCP port to connect to

        //Recipients
        $mail->setFrom('ciistacna@unjbg.edu.pe', 'XX CIIS');
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td id="body-text" style="padding: 0px;" te-edit="" class="moduloTexto" width="100%">
                                                                                                            ...
                                                                                                            <div>
                                                                                                                <h5>Atención: </h5>
                                                                                                                No olvide llevar su comprobante de pago a la hora de ingresar.
                                                                                                            </div>
                                                                                                            <div>&nbsp;</div>
                                                                                                        </td>
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td id="footer-text" width="100%" style="background-color: none;" te-edit="" class="moduloTexto" align="center">
                                                                                                            ...
                                                                                                            <div>&nbsp;</div>
                                                                                                            <div>Telf. +52 528000 anexo 51&nbsp;| Cel. +51 971 243 797&nbsp;</div>
                                                                                                            <div>&nbsp;</div>
                                                                                                    </tr>
