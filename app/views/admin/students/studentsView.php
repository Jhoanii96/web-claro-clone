...
<!--    
    ...
    AUTOR DE PROGRAMACIÓN Y DISEÑO DE LA PAGINA WEB CON ADMINLTE / ESTUDIANTES: 
...
<head>
	...
	<title>Estudiantes | XX CIIS</title>
	<!-- Bootstrap 3.3.7 -->
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Estudiante</a></li>
				</ol>
			</section>
			<br>
			<div class="col-md-12">
				<div class="nav-tabs-custom">
					...
					<div class="tab-content">
						<div class="active tab-pane" id="adding">
							...
							<form method="POST" class="form-horizontal" autocomplete="off" action="/2019/admin/students/save">
								<div class="form-group">
									<label for="inputName" class="col-sm-2 control-label">Nombres</label>

									<div class="col-sm-10">
										<input type="text" class="form-control" id="inputName" placeholder="" style="text-transform:uppercase" name="firstName">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="inputLast" placeholder="" style="text-transform:uppercase" name="lastName">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="inputDni" placeholder="" pattern="[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]" name="dni" maxlength="8">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" placeholder="" name="contact_point" id="contact_point" maxlength="15">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" type="email" pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" name="email" id="email">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" type="institution" name="institution">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" type="institution" name="qr" id="qr" maxlength="30" readonly>
									</div>
								</div>
								<div class="form-group">
										...
										<div class="box-body">
											<table id="example1" class="table table-bordered table-hover" style="font-size: 11px;">
												...
												<tbody>
													...
													while ($rowEstudiante = $data['datos_estudiante']->fetch_assoc()) {
														echo '
													<tr>
														<td>' . $rowEstudiante['numEst'] . '</td>	
														<td>' . $rowEstudiante['nomEst'] . '</td>
														<td>' . $rowEstudiante['apeEst'] . '</td>
														<td>' . $rowEstudiante['dniEst'] . '</td>
														<td>' . $rowEstudiante['celEst'] . '</td>
														<td>' . $rowEstudiante['emailEst'] . '</td>
														<td>' . $rowEstudiante['anioEst'] . '</td>
														<td>' . $rowEstudiante['paisEst'] . '</td>
														<td>' . $rowEstudiante['ciudadEst'] . '</td>
														<td title="' . $rowEstudiante['instEst'] . '">' . $rowEstudiante['instEst'] . '</td>
														<td class="button" align=\'center\'>
															<a href="' . FOLDER_PATH . '/admin/students/edit/' . $rowEstudiante['numEst'] . '">
																<input class="button-style" type=button value="Editar">
															</a>
														</td>
														<td class="button" align=\'center\'>
															<a href="' . FOLDER_PATH . '/admin/students/delete/' . $rowEstudiante['numEst'] . '">
