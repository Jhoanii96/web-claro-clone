...
<head>
	...
	<title>Organizador | XX CIIS</title>
	<!-- Bootstrap 3.3.7 -->
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Organizadores</a></li>
				</ol>
			</section>
			<br>
			<div class="col-md-12">
				<div class="nav-tabs-custom">
					...
					<div class="tab-content">
						<div class="active tab-pane" id="adding">
							...
							<form method="POST" enctype="multipart/form-data" autocomplete="off" class="form-horizontal" action="/2019/admin/organizers/save">
										...
										<div class="box-body">
											<table id="example1" class="table table-bordered table-hover" style="font-size: 12px;">
												...
												<?php 
													...
													while($rowOrgani=$data['datos_organizador']->fetch_assoc()){
														echo '
															<tr>
																<td>'.$rowOrgani['idOrg'].'</td>	
																<td>'.$rowOrgani['nombre'].'</td>
																<td>'.$rowOrgani['apellido'].'</td>	
																<td>'.$rowOrgani['dniUsu'].'</td>
																<td>'.$rowOrgani['celUsu'].'</td>
																<td>'.$rowOrgani['emailUsu'].'</td>
																<td>'.$rowOrgani['codOrganizador'].'</td>
																<td>'.$rowOrgani['claveOrganizador'].'</td>
																<td class="button" align=\'center\'>
																<a href="' . FOLDER_PATH . '/admin/organizers/edit/' . $rowOrgani['idOrg'] . '">
