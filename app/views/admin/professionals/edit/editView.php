...
<!--    
    ...
    AUTOR DE PROGRAMACIÓN Y DISEÑO DE LA PAGINA WEB CON ADMINLTE / PROFESIONALES - EDITAR: 
...
while ($datosProfesional = $data['datos_profesional_edit']->fetch_assoc()) {

	$nombre = $datosProfesional['nomPro'];
	$apellido = $datosProfesional['apePro'];
	$dni = $datosProfesional['dniPro'];
	$celular = $datosProfesional['celPro'];
	$email = $datosProfesional['emailPro'];
	$pais = $datosProfesional['paisPro'];
	$ciudad = $datosProfesional['ciudadPro'];
	$grado = $datosProfesional['gradoPro'];
	$qr = $datosProfesional['qrPro'];
}
...
<head>
	...
	<title>Editar profesional | XX CIIS</title>
	<!-- Bootstrap 3.3.7 -->
			...
			<div class="col-md-12">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Editar profesional: <?= $nombre . ' ' . $apellido ?></h3>
					...
					<form method="POST" enctype="multipart/form-data" autocomplete="off" class="form-horizontal" style="padding-left: 20px; padding-right: 20px; padding-bottom: 10px;">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" placeholder="" maxlength="5" id="numPro" name="numPro" value="<?= $data['numPro'] ?>" readonly />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="inputName" placeholder="" pattern="[A-Za-zÑÁÉÍÓÚáéíóúñ ]+" style="height: auto;" name="firstName" value="<?= $nombre ?>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="inputLast" placeholder="" pattern="[A-Za-zÁÉÍÓÚáéíóúñÑ ]+" style="height: auto;" name="lastName" value="<?= $apellido ?>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="inputDni" placeholder="" pattern="[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]" name="dni" maxlength="8" value="<?= $dni ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" placeholder="" name="contact_point" id="contact_point" maxlength="15" value="<?= $celular ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" type="email" pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" name="email" id="email" value="<?= $email ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" type="text" pattern="[a-zA-Z ]+" name="grade" id="grade" value="<?= $grado ?>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" type="institution" name="qr" id="qr" maxlength="30" value="<?= $qr ?>" readonly>
							</div>
						</div>
